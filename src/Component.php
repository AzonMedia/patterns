...
class Component extends BaseComponent
{
    ...
    protected const COMPONENT_NAME = "design Patterns package";
    protected const COMPONENT_URL = 'https://patterns.packages.guzaba.org/';
    ...
    protected const ERROR_REFERENCE_URL = 'https://github.com/AzonMedia/patterns/docs/ErrorReference/';
}